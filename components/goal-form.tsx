  ...
  return (
    <div className="w-full max-w-full rounded-[24px] border border-slate-200/70 bg-white/95 p-1.5 text-left shadow-xl shadow-sky-950/10 backdrop-blur-md transition-all duration-200 hover:border-sky-100 hover:shadow-sky-950/15 md:rounded-[28px] md:p-2.5 md:shadow-2xl">
      <form onSubmit={handleSubmit}>
        ...
        <div className="overflow-hidden rounded-[22px] border border-slate-100 bg-white transition focus-within:border-sky-300 focus-within:ring-4 focus-within:ring-sky-100 md:rounded-[24px]">
          <div className="px-3 pb-3 pt-3 md:px-5 md:pb-4 md:pt-4">
            ...
            <textarea
              ...
              rows={4}
              className="block min-h-[92px] w-full resize-none border-0 bg-transparent text-base leading-7 text-slate-950 outline-none placeholder:text-slate-400 md:min-h-[120px] md:text-lg lg:min-h-[140px]"
            />
            <div className="mt-2 flex flex-col items-stretch gap-2 md:flex-row md:flex-wrap md:items-center md:justify-between">
              <button
                type="button"
                aria-label="上传图片"
          ...
          <div className="grid grid-cols-3 gap-1 border-t border-slate-100 bg-slate-50/70 p-1 md:gap-0 md:p-0">
            {planningModes.map((mode, index) => {
              ...
              return (
                ...
                >
                  <span className="flex items-center justify-center gap-1 text-xs font-semibold md:justify-start md:gap-2 md:text-base">
                    {mode.title}
                  ...
                  <span className="mt-1 hidden text-xs leading-5 text-slate-500 md:block md:text-sm">{mode.description}</span>
                </button>
              );
            })}
          </div>
