            ...
            >
              {isUser ? (
                ...
                <div className="space-y-3">
                  ...
                  {message.answer?.note ? <p className="text-sm leading-6 text-slate-700">{message.answer.note}</p> : null}
                  {message.answer?.command ? (
                    <div className="overflow-hidden rounded-2xl border border-slate-200 bg-slate-950">
                      <div className="flex items-center justify-between gap-3 border-b border-white/10 px-4 py-2">
                        ...
                        <button
                          type="button"
                          onClick={() => copyCommand(message.answer?.command || '')}
                      ...
                      <pre className="overflow-x-auto px-4 py-3 text-sm leading-6 text-sky-100"><code>{message.answer.command}</code></pre>
                    </div>
                  ) : null}
                </div>
              )}
